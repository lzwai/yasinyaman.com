tinyMCE.init({
  ...
  theme_advanced_buttons1 : "fullscreen,code,separator,bold,italic,underline,strikethrough,separator,bullist,numlist,separator,undo,redo,separator,link,image",
